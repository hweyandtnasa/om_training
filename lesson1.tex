...
\section{Introduction to the Theory Behind Gradient-Based Optimization}
    ...
    We'll use a reference value for each quantity that provides the physical value that should be normalized to 1. The scaling equations\footnote{The equations for $\hat{F}$ and $\hat{G}$ are \textit{}} are as follows:
    \begin{align}
