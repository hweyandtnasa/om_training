...
\section{Introduction to the Theory Behind Gradient-Based Optimization}
    ...
    \begin{align}
        \hat{x} &= x \cdot \text{ref}_x^{-1} \label{eq:scale_x}\\
        \hat{F}(\hat{x}) &= \frac{F(x \cdot \text{ref}_x^{-1})}{\text{ref}_F} \label{eq:scale_F}\\
        \hat{G}(\hat{x}) &= \frac{G(x \cdot \text{ref}_x^{-1})}{\text{ref}_G} \label{eq:scale_G}
    \end{align}
